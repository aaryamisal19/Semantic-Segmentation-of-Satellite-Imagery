...
def load_images_and_patchify(directory_path, patch_size):
    ...
    for file_number, filepath in tqdm(enumerate(os.listdir(directory_path))):
        ...
        if extension == "jpg" or extension == "png":
            ...
            # width to the nearest size divisible by patch size
            size_x = (image.shape[1] // patch_size) * patch_size  
            
            # height to the nearest size divisible by patch size
...
# dataset directory
data_dir = r"C:/Users/ADMIN/Desktop/cvr project/Semantic segmentation dataset/"
...
checkpoint = ModelCheckpoint("C:/Users/ADMIN/Desktop", monitor="val_accuracy", verbose=2, save_best_only=True,
                             mode="max")
...
# model_dir = "C:/Users/ADMIN/Downloads/final_aerial_segmentation_2022-11-09 22_37_27_640199.hdf5"
# model_name = 'final_aerial_segmentation_2022-11-09 22_37_27_640199.hdf5'

# model = load_model(model_dir, custom_objects={'iou_coefficient': iou_coefficient, 'jaccard_index': jaccard_index})
# =====================================================
